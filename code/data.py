...
'''
Extracts the pictures from the dicom files, resizes them and saves them as numpy
This code is NOT used for the final version, because here we don't extract the localisation of the heart.
Therefore, the file plocalisation.py is used instead for preprocessing
'''
